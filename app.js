...
const jyotirlingaData = [
  {
    ...
    "itinerary": "Day 1: Arrival in Somnath, Visit Somnath Jyotirlinga Temple, Explore Bhalka Tirth, Triveni Sangam, and the Light & Sound Show at the temple,Overnight stay in Somnath.\nDay 2: Somnath to Dwarka (Approx. 4.5–5 hrs drive), Reach Dwarka and visit Dwarkadhish Temple, Evening Aarti and leisure at Gomti Ghat, Overnight stay in Dwarka.\nDay 3: Morning visit to Nageshwar Jyotirlinga Temple, Take a boat to Bet Dwarka (island temple of Lord Krishna), Visit Rukmini Temple on return, Overnight stay in Dwarka or travel to Gir (depending on pace) \nDay 4: Early morning Jeep Safari at Gir National Park, Visit Devalia Safari Park if time permits, Depart from Rajkot or Diu (nearest airports)",
